...
<s>We used [Vuforia](https://developer.vuforia.com/) package for [Unity3D](https://unity3d.com/).</s> To lighten the app, Vuforia dependency is removed, and native camera is utilized instead. Repo subfolder [Spot](Spot) is the Unity3D project. 

### Installation guidelines 

1. Open Unity project, <kbd>Command</kbd> + <kbd>Shift</kbd> + <kbd>B</kbd> to build on iOS
